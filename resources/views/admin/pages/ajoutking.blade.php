    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <h1>Ajouter un KingCash</h1>
                <form action="{{ route('create.King') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label">Nom du KingCash</label>
                        <input type="text" class="form-control" id="name" name="name" required>
                    </div>
                    <div class="mb-3">
                        <label for="location" class="form-label">Emplacement du KingCash</label>

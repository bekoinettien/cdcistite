...
<div class="container-fluid">
    <div class="row">
        ...
        @csrf
            <input type="hidden" name="id" value="{{ $about->id }}" style="display: none">
        <div>
            <input type="text" name="id" class="form-control" value="{{$about->id}}" style="display: none">
        </div>
         <div class="mb-3">
            ...
            <input type="file" class="form-control" id="libelle" name="image" accept="image/*" >
                    @if($about->image)
                            <div class="mt-2">
                                <p>Image actuelle :</p>
                                <img src="{{ asset('storage/' . $about->image) }}" alt="Image du service" style="max-width: 200px; max-height: 200px;">
                            </div>
                        @endif
        </div>
